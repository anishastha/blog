...
<div class="row justify-content-center">
  ...
  <div class="row">
    ...
    <div class="col-md-8">
      <form method="post" action="{{route('posts.update', $row->id)}}" enctype="multipart/form-data">{{csrf_field()}}
@method('put')
      ...
      <div>
         <textarea onkeyup="conversion();" name="nepbox" rows="8" cols="50"> Nepali </textarea>
      </div>
      <div class="form-group">
